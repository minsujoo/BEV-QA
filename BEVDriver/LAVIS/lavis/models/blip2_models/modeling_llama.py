...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.num_key_value_heads = self.num_heads #config.num_key_value_heads
    ...
    def _init_rope(self):
        try:
            pfwed = self.config.rope_scaling
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    def __init__(self, config):
        ...
        self.lm_head = nn.Linear(config.hidden_size, config.vocab_size, bias=False) # TODO lm_head
